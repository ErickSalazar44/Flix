...
const NavSearch = ({
    ...
    return (
        <nav
            className={`transition-all duration-300 ease-in fixed text-xs lg:text-sm w-full z-50 top-0 px-5 md:px-8 lg:px-12 2xl:px-16 h-[60px] flex justify-between items-center text-txtGray1 scrollMove ${lastScrollTop < duration
